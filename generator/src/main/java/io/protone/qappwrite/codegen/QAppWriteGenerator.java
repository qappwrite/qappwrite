...
public class QAppWriteGenerator extends CppQtAbstractCodegen implements CodegenConfig {
  ...
  public void processOpts() {
      ...
      if (additionalProperties.containsKey("modelNamePrefix")) {
          ...
          supportingFiles.add(new SupportingFile("globalExport-header.mustache", sourceFolder, modelNamePrefix + "GlobalExport.h"));
          ...
          importMapping.put(modelNamePrefix + "Object", "#include \"src/" + modelNamePrefix + "Object.h\"");
          importMapping.put(modelNamePrefix + "Enum", "#include \"src/" + modelNamePrefix + "Enum.h\"");
  ...
  public String modelFileFolder() {
      return outputFolder + "/" + sourceFolder + "/model/" + modelPackage().replace("::", File.separator);
  }
  ...
  public String apiFileFolder() {
      return outputFolder + "/" + sourceFolder + "/api/" + apiPackage().replace("::", File.separator);
  }
    ...
    public String toModelImport(String name) {
        ...
        return "#include \"src/model/" + folder + name + ".h\"";
    }
}
